...
extern void psd_ntugr_stage_specify_all_range(void);
extern void psd_specify_all_range(void);
extern void psd_refinement_WL_specify_all_range(void);

extern vector<Range_element*>psd_ntugr_stage_forbidden_region;
