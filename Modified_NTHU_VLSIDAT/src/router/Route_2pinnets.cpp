...
void psd_ntugr_stage_route_all_2pin_net(){
    vector<Point_fc *> all_cells;
	init_gridcell();
	define_interval();
	divide_grid_edge_into_interval();
	psd_ntugr_stage_specify_all_range();
}

void psd_route_all_2pin_net(void){
    psd_specify_all_range();
}
void psd_refinement_WL_route_all_2pin_net(void){
    psd_refinement_WL_specify_all_range();
}
