...
class EdgePlane {
    ...
    ///The real data structure of plane
    Vertex**   edgePlane_;
    std::vector<Vertex>* edgePool_;  //This is actually a pool that stores all vertice, each vertex contains two edges, so in general, it can be viewed as a prool of edges
