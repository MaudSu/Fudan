                                          ...
                                          unsigned int width)
{
    ...
    // psd_24: change in 2015.8.17
    routingSpace_->wireWidth.push_back(width);
}
                                            ...
                                            unsigned int spacing)
{
    ...
    // psd_24: change in 2015.8.17
    routingSpace_->wireSpacing.push_back(spacing);
}
                                   ...
                                   unsigned int viaSpacing)
{
    ...
    // psd_24: change in 2015.8.17
    routingSpace_->viaSpacing.push_back(viaSpacing);
}
